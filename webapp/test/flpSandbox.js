		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Idoc Monitor",
									"targetURL": "#cominetumidocmonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominetumidocmonitor-display": {
								"semanticObject": "cominetumidocmonitor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inetum.idocmonitor",
									"url": sap.ui.require.toUrl("com/inetum/idocmonitor")
								}
							}
						}
					}
